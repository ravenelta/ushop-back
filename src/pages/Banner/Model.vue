<template>
  ...
  >
    <el-form :model="form" :rules="rules" ref="formRef">
      ...
      <el-form-item label="分类名称" label-width="80px" prop="bannername">
        <el-input v-model="form.bannername" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item label="分类图片" label-width="80px" prop="img" v-show="form.pid!=0">
        <el-upload
  ...
  data() {
    return {
      ...
      rules: {
        ...
        bannername: [{ required: true, message: "请输入名称", trigger: "blur" }],
